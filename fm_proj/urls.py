...
from review_app.views import IndexView, ProfileView, StatusCreateView, ContactView, StatusDeleteView, RegisterView, SearchListView, FarmersMarketListView, FarmersMarketDetailView, FarmersMarketStatusCreateView, FarmersMarketCreateView, FarmersMarketUpdateView, ProfileFMLikeUpdateView, VendorDetailView, ProfileVendorLikeView, VendorStatusCreateView, VendorCreateView, VendorUpdateView, VendorDeleteView
