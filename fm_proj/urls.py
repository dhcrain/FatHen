...
from review_app.views import IndexView, ProfileView, StatusCreateView, RegisterView, SearchListView, FarmersMarketListView, FarmersMarketDetailView, FarmersMarketStatusCreateView, FarmersMarketCreateView, FarmersMarketUpdateView, VendorDetailView, VendorStatusCreateView, VendorCreateView, VendorUpdateView, RatingVendorCreateView
